...
. ",\"produit\"" . ":" . $jsonEncodeProduit 
. ",\"tbl_uploads\"" . ":" . $jsonEncodeTbl_uploads
. ",\"role\"" . ":" . $jsonEncodeRole
. ",\"privilege\"" . ":" . $jsonEncodePrivilege
. ",\"attr_priv_role\"" . ":" . $jsonEncodeAttr_Priv_Rol
. ",\"attr_role_user\"" . ":" . $jsonEncodeAttr_Rol_User
. "}";
